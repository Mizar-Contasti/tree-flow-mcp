...
export function registerEntityTools(client: TreeflowClient) {
  return [
    ...
    },
    {
      ...
      handler: async (args: { tree_id: string; name: string; values: Array<{ value: string; synonyms: string[] }> }) => {
    ...
    },
    {
      ...
      handler: async (args: { tree_id: string; entity_id: string; name?: string; values?: Array<{ value: string; synonyms: string[] }> }) => {
