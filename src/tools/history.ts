...
export function registerHistoryTools(client: TreeflowClient) {
  return [
    {
      ...
      handler: async (args: { tree_id: string; limit?: number }) => {
    ...
    },
    {
      ...
      handler: async (args: { tree_id: string; page?: number; page_size?: number }) => {
